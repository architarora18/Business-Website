        ...
        <div class="container">
            ...
            <div class="row services">
                <div class="col-md-3 text-center">
                    ...
                    <p>We will provide you best experience with ou websites<br>~Digital Waves</p>
                </div>
                <div class="col-md-3 text-center">
                    <div class="icon">
                    ...
                    <p> The future of mobile is the future of online. It is how people access online content now.<br>~Digital Waves</p>
                </div>
                <div class="col-md-3 text-center">
                    <div class="icon">
                    ...
                    <p>We've achieved the highest conversion rate on the market, Ignite your Career In Digital World<br>~Digital Waves</p>
                </div>
                <div class="col-md-3 text-center">
                    <div class="icon">
                    ...
                    <p>A profession or art of visual communication that combines words, images and ideas to express information to the audience.<br>~Digital Waves</p>
                </div>
            </div>      
        </div>     
    </section>
...
<div class="container">
<h1>Testimonials</h1>
<p class="text-center">Digital Waves</p>
<div class="row">
 <div class="col-md-4 text-center">
    <div class="profile">
    <img src="img/user1.jpg" class="user">
    <!--<blockquote>Digital Waves</blockquote>-->
        <h3>Archit Arora<br><span>Co-Founder at Digital Waves</span></h3>
    </div>      
 </div>
    <div class="col-md-4 text-center">
    <div class="profile">
    <img src="img/user1.jpg" class="user">
    <!--<blockquote>Digital Waves</blockquote>-->
        <h3>Archit Arora<br><span>Manager at Digital Waves</span></h3>
    </div>      
 </div>
    <div class="col-md-4 text-center">
    <div class="profile">
    <img src="img/user1.jpg" class="user">
    <!--<blockquote>Digital Waves</blockquote>-->
        <h3>Archit Arora<br><span>Founder / CEO at Digital Waves</span></h3>
    </div>      
 </div>
</div>
</div>
...
<section id="contact">
 <div class="container">
    ...
    <div class="col-md-6 contact-info">
        ...
        <div class="follow"><b>Phone:</b><i class="fa fa-phone"></i>+91 7589090900</div>
        <div class="follow"><b>Email:</b><i class="fa fa-envelope-o"></i>architarora900@gamil.com</div>
...
<!-----------Footer------->
    <section id="footer">
        <div class="container text-center">
            <p><a href="#top">Digital Waves</a> || contact us : +91 7589090900 || </p>
        </div>
    </section>
    <!------Footer End------>
